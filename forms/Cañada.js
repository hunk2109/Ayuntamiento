...
import {Input,Card,Button,Icon, Item, Label} from 'native-base'
...
export default class  Cañada extends React.Component { 
  ...
  constructor(props) {
    ...
    render(){  
      ...
      const destination = {latitude: 19.346254, longitude: -70.950731};
